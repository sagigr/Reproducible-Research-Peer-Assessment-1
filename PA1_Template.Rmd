...
'''{r missingvalues}
misvalcount <- sum(is.na(activitydata$steps))
'''
...
'''{r fillingmisvalues}
filledactivitydata <- function
intaveragesteps$averagesteps - average steps for each interval
if (is.na(activitydata$steps))
    filledactivitydata <- 
filledactivitydata <- function(steps, interval) {
    filled <- NA
